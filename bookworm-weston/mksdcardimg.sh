...
y
EOF
dd if=../rootfs-weston/linaro-esp.img of=${BOOT} bs=4096 seek=4096 conv=notrunc,fsync
dd if=../rootfs-weston/linaro-rootfs.img of=${BOOT} bs=4096 seek=135168 conv=notrunc,fsync
